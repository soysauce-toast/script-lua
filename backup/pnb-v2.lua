...
player_userId = getLocal().userId
value_y = userIdToValue[player_userId] or nil -- Default to nil if userId is not found
...
local block_pos_y = 52
local break_pos_x = 98
local break_pos_y = 48 - value_y
local drop_seed_x = 97
local drop_seed_y = 52
